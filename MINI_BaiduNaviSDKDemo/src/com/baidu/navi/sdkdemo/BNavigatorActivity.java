...
public class BNavigatorActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		BNavigatorTTSPlayer.setTTSPlayerListener(new IBNTTSPlayerListener() {
            ...
            public int playTTSText(String arg0, int arg1) {
            	//开发者可以使用其他TTS的API
            	//System.out.println(arg0+arg1+">>>此处为导航信息");
            	Data.setNaviInfo(arg0);//完整的导航信息
            	System.out.println(">>>arg0的信息>>"+arg0);
            	System.out.println(">>>arg1的信息>>"+arg1);
            	System.out.println(">>>导航文字信息>>>"+Data.getNaviInfo());
	...
	private IBNavigatorListener mBNavigatorListener = new IBNavigatorListener() {
        ...
        public void onYawingRequestSuccess() {
            // TODO 偏航请求成功
            System.out.println("偏航请求成功");
        }
        
        @Override
        public void onYawingRequestStart() {
            // TODO 开始偏航请求
        	 System.out.println("开始偏航请求");
        }
